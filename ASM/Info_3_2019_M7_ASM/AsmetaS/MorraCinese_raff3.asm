...
//E' il terzo raffinamento del modello MorraCinese.asm (raffinamento di
//MorraCinese_raff2.asm): se, dopo aver giocato il numero massimo di partite,
//il computer e l'utente sono in parita', permette che continuino a giocare
//fino a quando uno dei due non vince.
